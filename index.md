...
<table width="100%" align="center" border="0px" cellspacing="0" cellpadding="20">
  ...
  <tbody>
    ...
    <td width="50%" border="0px">
      ...
      A GAN based model for generating 3D objects from single RGB image. It was able to get better qualitative 3D reconstructions as compared to the baseline.</p>
      <!-- Image -->
